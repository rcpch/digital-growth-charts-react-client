...
This repository is not independently assured for clinical use. Known assurance gaps are recorded in [spec/roadmap.md](spec/roadmap.md), including comprehensive clinical assurance, patient-state review, example-scenario provenance, accessibility, and the browser credential boundary. Safety-relevant changes require independent review and must not rely on agent-generated tests as their sole evidence.
