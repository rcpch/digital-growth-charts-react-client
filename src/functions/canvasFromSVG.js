export const canvasFromSVG=(svg)=>{
    return new Promise((resolve, reject)=>{
        ...
        // add namespace
        if (!outerHTMLSVG.match(/xmlns="/mi)){
            outerHTMLSVG = outerHTMLSVG.replace ('<svg ','<svg xmlns="http://www.w3.org/2000/svg" ') ;  
        }
        // create blob
        const blob = new Blob([outerHTMLSVG],{type:'image/svg+xml;charset=utf-8'});
        // create url
